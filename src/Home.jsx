...
function Home() {
  ...
  const fetchExpenses = async email => {
    try {
      const res = await fetch("https://expanse-tracker-backend-atv7.onrender.com/get-expanses");
  ...
  const addExpense = async e => {
    ...
    try {
      ...
      await fetch("https://expanse-tracker-backend-atv7.onrender.com/add-expanse", {
        method: "POST",
  ...
  const removeExpense = async () => {
    ...
    try {
      await fetch("https://expanse-tracker-backend-atv7.onrender.com/remove-expanses", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const submitLogout = async () => {
    ...
    try {
      await fetch("https://expanse-tracker-backend-atv7.onrender.com/delete-login-user");
...
const resetApp = () => {
  ...
  fetch("https://expanse-tracker-backend-atv7.onrender.com/reset-app", { method: "GET" })
    .then(res => res.json())
    .catch(err => {
